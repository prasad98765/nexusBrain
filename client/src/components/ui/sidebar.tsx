...
export function Sidebar() {
  ...
  const navItems = [
    { path: "/About/AI", label: "AI", icon: Brain },
    { path: "/About/langchain", label: "LangChain", icon: LinkIcon },
    { path: "/About/LLM", label: "LLM", icon: Zap }
  ];
  ...
  return (
    <>
      ...
      <Button
        ...
        onClick={toggleSidebar}
        className="fixed top-4 left-4 z-50 lg:hidden bg-accent hover:bg-accent/90 p-2 h-10 w-10"
        size="sm"
      >
