...
interface RefactoredFlowBuilderProps {
    workspaceId: string;
    isFullScreen: boolean;
    onToggleFullScreen: () => void;
}

function RefactoredFlowBuilderInner({ workspaceId, isFullScreen, onToggleFullScreen }: RefactoredFlowBuilderProps) {
    ...
    const handleSaveNodeConfig = (data: any) => {
        ...
        // Don't close the panel here - let the NodeConfigPanel handle closing
    };
...
export default function RefactoredFlowBuilder(props: RefactoredFlowBuilderProps) {
    return (
        <ReactFlowProvider>
            <RefactoredFlowBuilderInner {...props} />
        </ReactFlowProvider>
    );
}
