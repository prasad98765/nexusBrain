    ...
    <div className="bg-slate-700 rounded-lg border border-slate-700 shadow-xl min-w-[280px]">
      ...
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-slate-700">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-slate-200">{data.label || 'Language Model'}</span>
        </div>
      ...
      <div className="p-4 space-y-3">
        <div>
          <label className="text-xs text-slate-400 mb-1 block">Model Provider</label>
