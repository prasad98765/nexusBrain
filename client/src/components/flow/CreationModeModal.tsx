            ...
            <DialogContent className="max-w-4xl bg-slate-900 border-slate-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    ...
                    <button
                        ...
                        className="group relative p-6 bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-slate-700 rounded-lg hover:border-purple-500 transition-all hover:shadow-lg hover:shadow-purple-500/20 text-left"
                    >
                        <div className="flex items-start gap-4">
                            <div className="p-3 bg-purple-500/20 rounded-lg ring-1 ring-purple-500/30 group-hover:ring-purple-500/50 transition-all">
