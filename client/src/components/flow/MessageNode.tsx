                    ...
                    <div className="flex items-center gap-2.5 flex-1">
                        ...
                        {isEditingLabel ? (
                            <input
                                ...
                                className="text-sm font-semibold text-slate-100 bg-transparent border-b border-blue-400 outline-none px-1 focus:border-blue-300"
                                autoFocus
                            ...
                            <div className="bg-slate-800 p-4 border-b border-slate-700">
                                ...
                                {data.media.type === 'image' && data.media.url && (
                                    <img
                                        ...
                                        className="w-full h-32 object-cover rounded-md border border-slate-700 shadow-lg"
                                        onError={(e) => {
                                ...
                                {data.media.type === 'video' && data.media.url && (
                                    <video
                                        src={data.media.url}
                                        controls
                                        className="w-full h-32 rounded-md border border-slate-700 shadow-lg"
                                    />
                                )}
                                {data.media.type === 'document' && (
                                    <div className="flex items-center gap-3 p-3 bg-slate-700 rounded-md border border-slate-700">
                                        <div className="p-2 bg-orange-500/20 rounded">
                                            <FileText className="h-5 w-5 text-orange-400" />
                                        </div>
                                        <span className="text-sm text-slate-300 truncate flex-1">{data.media.name || data.media.url}</span>
                                    </div>
                                )}
                            </div>
                        )}
                                    ...
                                    {data.buttons.map((btn, idx) => {
                                        ...
                                        return (
                                            <div key={btn.id} className="relative group">
                                                <div className={`bg-gradient-to-br from-slate-800 to-slate-900 border rounded-lg px-3.5 py-2.5 transition-all hover:shadow-md ${!isValid ? 'border-red-500/50 shadow-red-500/10' : 'border-gray-600/50 hover:border-blue-500/30'
                                                    }`}>
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        <span className="font-semibold text-sm text-slate-200">{btn.label}</span>
                                                    </div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {data.media && (
                                <div className="flex-shrink-0">
                                    {data.media.type === 'image' && data.media.url && (
                                        <div className="relative w-8 h-8 rounded border border-slate-600 overflow-hidden bg-slate-800">
                                            <img
                                                src={data.media.url}
                                                alt="thumbnail"
